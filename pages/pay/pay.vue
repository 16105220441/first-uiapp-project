	...
	<view class="page-container">
		<view class="page-header" @click="goToAddressList">
			<uni-row>
				...
				<uni-col :span="18">
					<view class="info" v-if="default_address">
		...
		<view class="pay-list">
			<uni-row :gutter="20"  v-if="ProInfo">
				<uni-col :span="8">
		...
		<view class="pay-info">
			<uni-row class="pay-detail">
				...
				<uni-col :span="12" class="custom-class">￥{{proNum *  ProInfo.discountPrice}}</uni-col>
			</uni-row>
			...
			<uni-row class="pay-cell">
				...
				<uni-col :span="12" v-if="!default_address" class="right-text"><text>
						请先选择配送地址</text></uni-col>
				<uni-col :span="12" v-else class="custom-class right-text"><text>
						+￥0.00
					</text></uni-col>
			</uni-row>
		</view>
		...
		<u-cell-group inset>
			<u-textarea v-model="message" count rows="2" autosize type="textarea" maxlength="50"
				placeholder="选填：买家留言（50字以内）" border>
			</u-textarea>
		</u-cell-group>
	...
	<view class="footer-container">
		<view  class="footer">
			<uni-row>
				...
				<uni-col :span="8" :offset="7" class="button-block">
